...
st.caption(
    ...
    "and `reports/backtest_predictions*.csv`, generated by the model comparison, "
    "interval coverage, and walk-forward evaluation pipeline."
)
...
st.caption(
    "Empirical coverage is compared with the nominal interval target; flagged points mark "
    "rows where the report's binomial test labels coverage as significantly miscalibrated. "
    "Current committed evidence remains below nominal overall."
)
