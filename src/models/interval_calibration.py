...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--factors-output", type=Path, default=INTERVAL_CALIBRATION_FACTORS_PATH)
    parser.add_argument(
        "--validation-output",
        type=Path,
        default=INTERVAL_CALIBRATION_VALIDATION_OUTPUT_PATH,
    )
    parser.add_argument(
        "--origin-count-report",
        type=Path,
        default=INTERVAL_COVERAGE_OUTPUT_PATH,
    )
    ...
    factors, comparison = run_interval_calibration(
        ...
        factors_output_path=args.factors_output,
        validation_output_path=args.validation_output,
        origin_count_report_path=args.origin_count_report,
