...
SERIES_SPECS = [
    ...
    SeriesSpec(
        ...
        path=Path("dataset/abs/unemployment_rate_1995_2025.csv"),
    ...
    SeriesSpec(
        name="cash_rate",
        path=Path("dataset/rba/cash_rate_1995_2025.csv"),
        value_col="cash_rate",
    ...
    SeriesSpec(
        ...
        path=Path("dataset/abs/wage_price_index_1995_2025.csv"),
    ...
    SeriesSpec(
        ...
        path=Path("dataset/abs/producer_price_index_1995_2025.csv"),
    ...
    SeriesSpec(
        ...
        path=Path("dataset/rba/commodity_prices_1995_2025.csv"),
        value_col="GRCPAIAD",
    ...
    SeriesSpec(
        name="aud_usd",
        path=Path("dataset/rba/aud_usd_exchange_rate_1995_2025.csv"),
        value_col="FXRUSD",
        output_col="aud_usd",
        agg="mean",
    ),
    SeriesSpec(
        ...
        path=Path("dataset/abs/household_spending_1995_2025.csv"),
    ...
    SeriesSpec(
        ...
        path=Path("dataset/rba/inflation_expectations_1995_2025.csv"),
        value_col="GBUSEXP",
